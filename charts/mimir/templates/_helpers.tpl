...
{{/*
Create the base url for jobs to use
*/}}
{{- define "mimir.baseUrl" -}}
http:// {{- include "mimir.fullname" . }}{{ .Values.mimir_route }}
{{- end }}

{{- define "mimir.imageTag" -}}
{{ $vMap := $.Chart.Version | split "." }}
{{- default $vMap._1 .Values.image.tag -}}
{{- end }}
